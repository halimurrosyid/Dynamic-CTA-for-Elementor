 ...
 * Description:       Dynamic area-based CTA link migration plugin for Elementor. Dynamically changes image, button, and popup CTA URLs based on post slug, categories, and tags.
 * Version:           1.0.0
...
define('DYNAMIC_CTA_VERSION', '1.0.0');
