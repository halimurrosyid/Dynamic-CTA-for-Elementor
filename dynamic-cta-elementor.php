 ...
 * Description:       Universal area-based CTA link migration plugin for Elementor. Dynamically changes image, button, and popup CTA URLs based on post slug, URL path segments, categories, and tags.
 * Version:           1.0.3
...
define('DYNAMIC_CTA_VERSION', '1.0.3');
